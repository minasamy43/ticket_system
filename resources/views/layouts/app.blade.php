    ...
    <div class="container-fluid">
      <a class="brand-wrapper"
        ...
        <div class="brand-logo-wrap">
          <img src="{{ asset('img/Gold-Era.png') }}" alt="Gold Era Logo">
        </div>
        <div class="brand-divider"></div>
        <span class="brand-title">Ticket System</span>
      </a>
  ...
  <footer class="footer-pro">
    <div class="footer-container">
      <div class="footer-copyright">
        &copy; {{ date('Y') }} <span style="color: #d4af53; font-weight: 500;">Gold Era</span>. All rights reserved.
      </div>
    </div>
  </footer>
