...
<div class="premium-container container">
    <div class="row align-items-end mb-5">
        ...
        <div class="col-lg-5">
            <form action="{{ route('admin.ranking.index') }}" method="GET" class="filter-section d-flex gap-3 align-items-end mb-0">
                ...
                <button type="submit" class="btn btn-gold-action shadow-none">
                    Show
                </button>
            </form>
        </div>
                ...
                <div class="premium-card h-100">
                    ...
                    <div class="ranking-list">
                        ...
                        @foreach($rankings as $index => $ranking)
                            ...
                            @endphp
                            <div class="top-performer-card {{ $ranking->tickets_count == $maxTickets ? 'leader' : '' }}" style="animation: slideIn {{ 0.3 + ($index * 0.1) }}s ease forwards;">
                                ...
                                <div class="ticket-count-badge">
                                    {{ $ranking->tickets_count }} <span class="small font-weight-normal opacity-75">Solved</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
